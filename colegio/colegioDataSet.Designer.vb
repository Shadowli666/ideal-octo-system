...
Partial Public Class colegioDataSet
    ...
    Partial Public Class estudiantesDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Overloads Function AddestudiantesRow(ByVal nombre As String, ByVal apellido As String, ByVal edad As Integer) As estudiantesRow
            Dim rowestudiantesRow As estudiantesRow = CType(Me.NewRow,estudiantesRow)
            Dim columnValuesArray() As Object = New Object() {Nothing, nombre, apellido, edad}
...
Namespace colegioDataSetTableAdapters
    ...
    Partial Public Class estudiantesTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM `estudiantes` WHERE ((`Id` = ?) AND ((? = 1 AND `nombre` IS NULL) OR "& _ 
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO `estudiantes` (`nombre`, `apellido`, `edad`) VALUES (?, ?, ?)"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE `estudiantes` SET `nombre` = ?, `apellido` = ?, `edad` = ? WHERE ((`Id` = "& _ 
                "?) AND ((? = 1 AND `nombre` IS NULL) OR (`nombre` = ?)) AND ((? = 1 AND `apellid"& _ 
                "o` IS NULL) OR (`apellido` = ?)) AND ((? = 1 AND `edad` IS NULL) OR (`edad` = ?)"& _ 
                "))"
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT Id, nombre, apellido, edad FROM estudiantes"
        ...
        Public Overloads Overridable Function Fill(ByVal dataTable As colegioDataSet.estudiantesDataTable) As Integer
        ...
        Public Overloads Overridable Function GetData() As colegioDataSet.estudiantesDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As colegioDataSet.estudiantesDataTable = New colegioDataSet.estudiantesDataTable()
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataTable As colegioDataSet.estudiantesDataTable) As Integer
        ...
        Public Overloads Overridable Function Delete(ByVal Original_Id As Integer, ByVal Original_nombre As String, ByVal Original_apellido As String, ByVal Original_edad As Global.System.Nullable(Of Integer)) As Integer
        ...
        Public Overloads Overridable Function Insert(ByVal nombre As String, ByVal apellido As String, ByVal edad As Global.System.Nullable(Of Integer)) As Integer
        ...
        Public Overloads Overridable Function Update(ByVal nombre As String, ByVal apellido As String, ByVal edad As Global.System.Nullable(Of Integer), ByVal Original_Id As Integer, ByVal Original_nombre As String, ByVal Original_apellido As String, ByVal Original_edad As Global.System.Nullable(Of Integer)) As Integer
            If (nombre Is Nothing) Then
            ...
            If (Original_edad.HasValue = true) Then
                ...
                Me.Adapter.UpdateCommand.Parameters(9).Value = CType(Original_edad.Value,Integer)
            Else
